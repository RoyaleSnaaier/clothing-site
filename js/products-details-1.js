...
// Get the front-image-info element
let frontImageInfo = document.querySelector('.image-container .front-image-info');

// Add event listener to front-image-info-small
document.querySelector('.front-image-info-small').addEventListener('click', function() {
  // Fade out the image smoothly
  frontImageInfo.style.opacity = 0;

  // Set a timeout to change the source of the image after the fade out effect
  setTimeout(() => {
    frontImageInfo.src = this.src;

    // Fade in the new image smoothly
    frontImageInfo.style.opacity = 1;
  }, 300); // Adjust the timeout duration to match your CSS transition duration
});

// Add event listener to back-image-info-small
document.querySelector('.back-image-info-small').addEventListener('click', function() {
  // Fade out the image smoothly
  frontImageInfo.style.opacity = 0;
...
// Add hover effect to front-image-info-small
document.querySelector('.front-image-info-small').addEventListener('mouseover', function() {
  // Apply hover effect
  this.style.transform = 'scale(1.1)';
});

document.querySelector('.front-image-info-small').addEventListener('mouseout', function() {
  // Remove hover effect
  this.style.transform = 'scale(1)';
});

// Add hover effect to back-image-info-small
document.querySelector('.back-image-info-small').addEventListener('mouseover', function() {
  // Apply hover effect
  this.style.transform = 'scale(1.1)';
});

document.querySelector('.back-image-info-small').addEventListener('mouseout', function() {
  // Remove hover effect
  this.style.transform = 'scale(1)';
});
